...
def keys_save(
    private_key_readable: str, public_key_readable: str, address: str, file
) -> None:
    wallet_dict = dict()
...
def keys_load(
    privkey_filename: str = "privkey.der", pubkey_filename: str = "pubkey.der"
):
    keyfile = "wallet.der"
